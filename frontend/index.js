...
window.addEventListener('DOMContentLoaded', (event) => {
    setTimeout(() => {
        ...
        const buttonDetails = [
            { id: 'button-uber-eats', text: 'Uber Eats', url: 'https://www.ubereats.com' },
            { id: 'button-amazon', text: 'Amazon', url: 'https://www.amazon.com' },
            { id: 'button-university-east-london', text: 'University of East London', url: 'https://www.uel.ac.uk' }
        ];
